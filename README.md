  ...
  <tr>
    <td>
      <ul>
        ...
        Mentre i semiconduttori non possono essere vantaggiosamente impiegati in presenza di esposizione a radiazioni ionizzanti, in quanto ne risulterebbero danneggiati, i tubi a vuoto risultano immuni a tali radiazioni.</li>
      </ul>
    </td>
    <td>
